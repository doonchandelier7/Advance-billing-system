...
function addRow() {
    ...
    tr.innerHTML='<td style="font-weight:500;">'+pname+'</td><td>'+q+'</td><td>'+unit.value+'</td><td>'+hsn.value+'</td><td class="text-right">'+r.toFixed(2)+'</td><td class="text-right">'+amount.toFixed(2)+'</td><td class="tax-percent-cell">'+g+'%</td><td class="text-right" style="color:#ff7675;">'+tax.toFixed(2)+'</td><td class="text-right" style="font-weight:700; color:#a4b4f4;">'+net.toFixed(2)+'</td><td><button type="button" class="btn btn-danger btn-sm py-0 px-1" onclick="removeRow(this,'+idx+')"><i class="fas fa-trash" style="font-size:0.7rem;"></i></button></td>';
...
$(function(){
    setTimeout(function(){
        if (typeof $.fn.select2 !== 'undefined') {
            $('#pur-vendor').select2({ width: '100%', minimumResultsForSearch: 0, placeholder: 'Search vendor...' });
