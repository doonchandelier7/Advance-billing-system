...
<head>
    ...
    <title>Invoice {{ $invoice->doc_number ?? $invoice->id }}</title>
    <style>
...
<body>
    ...
    <p style="margin-top: 32px; color: #666;">Use your browser’s <strong>Print</strong> → <strong>Save as PDF</strong> to download as PDF.</p>
